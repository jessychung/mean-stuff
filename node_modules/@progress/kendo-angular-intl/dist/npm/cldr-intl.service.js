...
var kendo_intl_2 = require('@telerik/kendo-intl');
var kendo_intl_3 = require('@telerik/kendo-intl');
/**
...
var CldrIntlService = (function () {
    ...
    CldrIntlService.prototype.toString = function (value, format, localeId) {
        return kendo_intl_1.toString(value, format, localeId || this.localeId);
    };
    /**
    ...
    CldrIntlService.prototype.formatDate = function (value, format, localeId) {
        return kendo_intl_2.formatDate(value, format, localeId || this.localeId);
    };
    /**
    ...
    CldrIntlService.prototype.parseDate = function (value, format, localeId) {
        return kendo_intl_2.parseDate(value, format, localeId || this.localeId);
    };
    /**
    ...
    CldrIntlService.prototype.parseNumber = function (value, format, localeId) {
        return kendo_intl_3.parseNumber(value, localeId || this.localeId, format);
    };
    /**
    ...
    CldrIntlService.prototype.formatNumber = function (value, format, localeId) {
        return kendo_intl_3.formatNumber(value, format, localeId || this.localeId);
    };
    /**
    ...
    CldrIntlService.prototype.dateFormatNames = function (options, localeId) {
        return kendo_intl_2.dateFormatNames(localeId || this.localeId, options);
    };
    /**
    ...
    CldrIntlService.prototype.firstDay = function (localeId) {
        return kendo_intl_2.firstDay(localeId || this.localeId);
    };
