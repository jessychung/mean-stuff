...
/***/ function(module, exports) {
	...
	function caretSelection(element, startIndex) {
	    var endIndex = arguments.length <= 2 || arguments[2] === undefined ? startIndex : arguments[2];
	...
	function resolveValue(props) {
	    ...
	    var dataItem = void 0;
	    if (value) {
	        dataItem = data.find(function (element) {
	            return getter(element, valueField) === value;
	        });
	        return {
	            dataItem: dataItem,
